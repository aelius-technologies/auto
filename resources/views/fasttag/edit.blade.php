                    ...
                    <form action="{{ route('fasttag.update') }}" name="form" id="form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" name="tag_id" id="tag_id" class="form-control" placeholder="Enter Tag ID" value="{{ $data->tag_id ??'' }}">
                                <span class="kt-form__help error tag_id"></span>
                            </div>
                            <div class="form-group col-sm-6">
                                <label for="amount">Amount</label>
                                <input type="number" name="amount" id="amount" class="form-control" placeholder="Enter Amount" value="{{ $data->amount ??'' }}">
