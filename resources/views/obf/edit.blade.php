...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-7 align-self-center">
            <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">OBF Edit</h4>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form role="form" action="{{ route('obf.update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="date" name="booking_date" id="booking_date" class="form-control" value="{{ $data->booking_date ?? '' }}">
                                            <span class="kt-form__help error booking_date"></span>
                                        </div>
                                        
                                        <div class="form-group col-md-6">
                                            <label class="control-label">Customer Name</label>
                                            <input type="text"  name="customer_name" id="customer_name" class="form-control" placeholder="Enter Customer Name" value="{{ $data->customer_name ?? '' }}">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea  name="address_1" id="address_1" class="form-control" placeholder="Enter Address Correspondence">{{ $data->address ?? '' }}</textarea>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="email"  name="email" id="email" class="form-control" placeholder="Enter Email Address" value="{{ $data->email ?? '' }}">
                                            <span class="kt-form__help error email"></span>
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label class="control-label">Mobile Number</label>
                                            <input type="number"  name="contact_number" id="contact_number" class="form-control" placeholder="Enter Mobile Number" value="{{ $data->contact_number ?? '' }}">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number"  name="adhar_number" id="aadhar_number" class="form-control" placeholder="Enter Aadhar Number" value="{{ $data->adhar_number ??'' }}" >
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text"  name="nominee_name" id="nominee_name" class="form-control" placeholder="Enter Nominee Name" value="{{ $data->nominee_name ?? '' }}">
                                            <span class="kt-form__help error nominee_name"></span>
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label class="control-label">Nominee Relation</label>
                                            <input type="text"  name="nominee_relation" id="nominee_relation" class="form-control" placeholder="Enter Nominee Relation" value="{{ $data->nominee_reletion ?? ''}}">
                                            <span class="kt-form__help error nominee_relation"></span>
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label class="control-label">Nominee Age</label>
                                            <input type="number"  name="nominee_age" id="nominee_age" class="form-control" placeholder="Enter Nominee Age" value="{{ $data->nominee_age ?? '' }}">
                                            <span class="kt-form__help error nominee_age"></span>
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label class="control-label">Occupation</label>
                                            <input type="text"  name="occupation" id="occupation" class="form-control" placeholder="Enter Occupation" value="{{ $data->occupation ?? '' }}">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text"  name="interior_color" id="interior_color" class="form-control" placeholder="Enter Interior Color" value="{{ $data->interior_color ?? '' }}">
                                            <span class="kt-form__help error interior_color"></span>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="control-label">Standard Ex-Showroom Price</label>
                                            <input type="number"  name="ex_showroom_price" id="ex_showroom_price" class="form-control" placeholder="Enter Standard Ex-Showroom Price" value="{{ $data->ex_showroom_price ?? '' }}">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" name="on_road_price" id="on_road_price" class="form-control" placeholder="Enter On Road Price" value="{{ $data->on_road_price ?? '' }}">
                                            <span class="kt-form__help error on_road_price"></span>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="control-label">On Road Price (In Words)</label>
                                            <input type="text" name="on_road_price_word" id="on_road_price_word" class="form-control" placeholder="Enter On Road Price In Words" value="{{ $data->on_road_price_word ?? '' }}">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="date" name="tentative_delivery_date" id="tentative_delivery_date" class="form-control" value="{{ $data->tentative_delivery_date ?? '' }}">
                                            <span class="kt-form__help error tentative_delivery_date"></span>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="control-label">Booking Amount</label>
                                            <input type="number"  name="booking_amount" id="booking_amount" class="form-control" placeholder="Enter Booking Amount" value="{{ $data->booking_amount ?? '' }}">
