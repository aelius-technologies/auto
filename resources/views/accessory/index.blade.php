...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-7 align-self-center">
            <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Accessory Master</h4>
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}" class="text-muted">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('accessory') }}" class="text-muted">Accessory Master</a></li>
        ...
        <div class="col-5 align-self-center">
            <div class="customize-input float-right">
                ...
                <!-- Export -->
                @canany(['accessories-create'])
                    <a class="btn waves-effect waves-light btn-rounded btn-outline-primary pull-right" href="{{ route('accessory.create') }}">Add New</a>
                @endcanany
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="col-md-12 align-self-center collapse" id="collapseExample">
                <div class="customize-input float-right">
                    <form action="{{ route('accessory.export') }}" method="get">
                        <div class="row">
    ...
    $(document).ready(function() {
            ...
            function change_status(object) {
                ...
                if (confirm('Are you sure?')) {
                    $.ajax({
                        "url": "{!! route('accessory.change.status') !!}",
                        "dataType": "json",
                        "type": "POST",
                        "data": {
                            id: id,
