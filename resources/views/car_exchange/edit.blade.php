                    ...
                    <form action="{{ route('car_exchange.update') }}" name="form" id="form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" class="form-control" id="engine_number" name="engine_number" value="{{$data->engine_number ?? ''}}">
                                <span class="kt-form__help error engine_number"></span>
                            </div>
                            
                            <div class="form-group col-sm-6">
                                <label for="chassis_number">Chassis Number</label>
                                <input type="text" class="form-control" id="chassis_number" name="chassis_number" value="{{$data->chassis_number ?? ''}}">
