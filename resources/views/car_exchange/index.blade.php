...
<div class="page-breadcrumb">
    <div class="row">
        ...
        <div class="customize-input float-right">
                @canany(['car_exchange-create'])
                    <a class="btn waves-effect waves-light btn-rounded btn-outline-primary pull-right" href="{{ route('car_exchange.create') }}">Add New</a>
                @endcanany
            </div>
        </div>
    </div>
    ...
    $(document).ready(function() {
            ...
            function change_status(object) {
                ...
                if (confirm('Are you sure?')) {
                    $.ajax({
                        "url": "{!! route('car_exchange.change.status') !!}",
                        "dataType": "json",
                        "type": "POST",
                        "data": {
                            id: id,
