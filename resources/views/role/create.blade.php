...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('role.insert') }}" name="form" id="form" method="post">
                        @csrf
                        @method('POST')
                                        ...
                                        @foreach($permissions as $value)
                                            <div class="col-sm-3">
                                                <label class="ui-checkbox ui-checkbox-success mt-2" for="checkbox-{{ $value->id }}">
                                                    <input type="checkbox" class="checkboxClass" name="permissions[]" id="checkbox-{{ $value->id }}" value="{{ $value->id }}">
