                    ...
                    <form action="{{ route('branches.update') }}" name="form" id="form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" name="address" id="address" class="form-control" placeholder="Enter Address" value="{{ $data->address ??'' }}">
                                <span class="kt-form__help error address"></span>
                            </div>
                            <div class="form-group col-sm-6">
                                <label for="email">Email</label>
                                <input type="email" name="email" id="email" class="form-control" placeholder="Enter Email" value="{{ $data->email ??'' }}">
                                <span class="kt-form__help error email"></span>
                            </div>
                            <div class="form-group col-sm-6">
                                <label for="contact_number">Contact Number</label>
                                <input type="text" name="contact_number" id="contact_number" class="form-control" placeholder="Enter Contact Number" value="{{ $data->contact_number ??'' }}">
                                <span class="kt-form__help error contact_number"></span>
                            </div>
                            <div class="form-group col-sm-6">
                                <label for="manager">Manager</label>
                                <input type="text" name="manager" id="manager" class="form-control" placeholder="Enter Manager" value="{{ $data->manager ??'' }}">
                                <span class="kt-form__help error manager"></span>
                            </div>
                            <div class="form-group col-sm-6">
                                <label for="manager_contact_number">Manager Contact Number</label>
                                <input type="number" name="manager_contact_number" id="manager_contact_number" class="form-control" placeholder="Enter Manager Contact Number" value="{{ $data->manager_contact_number ??'' }}">
