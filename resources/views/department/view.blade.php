...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('department.view') }}" name="form" id="form" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('GET')
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" name="name" id="name" class="form-control" placeholder="Enter Department Name" value="{{ $data->name ??'' }}" disabled>
                                <span class="kt-form__help error name"></span>
                            </div>
                            <div class="form-group col-md-6">
                                <label class="control-label">Branch</label>
                                    <select name="branch" id="branch" class="form-control" disabled>  
                                        <option value="">{{ $data->branch_name ?? 'Select Branch' }}</option>
                                    </select>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="number" name="number" id="number" class="form-control" placeholder="Enter Contact Number" value="{{ $data->number ??'' }}" disabled>
                                <span class="kt-form__help error number"></span>
                            </div>
                            <div class="form-group col-md-6">
                                <label class="control-label">Authorised Person</label>
                                    <input name="authorised_person" value="{{ $data->authorised_person ??'' }}" id="authorised_person" class="form-control" disabled>
