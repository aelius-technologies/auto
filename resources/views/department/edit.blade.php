                    ...
                    <form action="{{ route('department.update') }}" name="form" id="form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" name="name" id="name" class="form-control" placeholder="Enter Department Name" value="{{ $data->name ??'' }}">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="number" name="number" id="number" class="form-control" placeholder="Enter Contact Number" value="{{ $data->number ??'' }}">
